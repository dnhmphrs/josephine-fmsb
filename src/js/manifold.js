/* ===========================================================================
   Josephine Shen — WebGPU manifold background
   ---------------------------------------------------------------------------
   ...
   Coloring is the original iridescent log(sin/cos/tan(dot)) pattern, keyed off
   the framebuffer position + world position exactly as in Rust. Composited
   over the washi ground with GHOST_ALPHA for the ghostly look (1.0 = exact
   opaque Rust look). Cursor orbits the perspective camera. A scan band sweeps
   across world-x as a brightness highlight.

   Drop-in via background.js (falls back to bg.js when WebGPU is unavailable).
   Caps DPR at 2, respects prefers-reduced-motion (freezes auto-animation;
   cursor-orbit stays live).
   =========================================================================== */
